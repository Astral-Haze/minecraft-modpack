...
ServerEvents.recipes(event => {
  event.recipes.gtceu.macerator('astral:macerate_ironwood_ingot')
    .itemInputs(
...
event.shaped(
  ...
  event.recipes.gtceu.macerator('astral:macerate_ironwood_plate')
    .itemInputs(
    ...
    .duration(66)
    .EUt(4)
  event.recipes.gtceu.macerator('astral:macerate_knightmetal_ingot')
    .itemInputs(
...
event.shaped(
  ...
  event.recipes.gtceu.macerator('astral:macerate_knightmetal_plate')
    .itemInputs(
...
event.recipes.gtceu.lathe('astral:lathe_knightmetal_ingot')
    .itemInputs(
      'twilightforest:knightmetal_ingot'
    )
    .itemOutputs(
    ...
    .duration(52)
    .EUt(16)
  event.recipes.gtceu.macerator('astral:macerate_knightmetal_ring')
    .itemInputs(
